...
(function (root, factory) {
  ...
  (function ($) {
    ...
    Selectpicker.DEFAULTS = {
      noneSelectedText: 'لا توجد اختيارات',
      noneResultsText: 'لا توجد نتائج للبحث {0}',
      ...
      deselectAllText: 'الغاء الاختيار',
      doneButton: false,
      ...
      createDropdown: function () {
        ...
        drop =
          '<div class="dropdown bootstrap-select' + showTick + inputGroup + '">' +
            '<button type="button" class="' + this.options.styleBase + ' dropdown-toggle" ' + (this.options.display === 'static' ? 'data-display="static"' : '') + 'data-bs-toggle="dropdown"' + autofocus + ' role="combobox" aria-owns="' + this.selectId + '" aria-haspopup="listbox" aria-expanded="false">' +
    ...
    $(document)
      ...
      .on('keydown.bs.dropdown.data-api', ':not(.bootstrap-select) > [data-bs-toggle="dropdown"]', bootstrapKeydown)
  ...
  //# sourceMappingURL=bootstrap-select-ar.js.map